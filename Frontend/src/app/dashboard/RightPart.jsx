...
const RightPart = ({id,certifications_course_name, certifications_institute, education_duration_end, education_duration_start, education_institute, experiences_designation, experiences_duration_end, experiences_duration_start, experiences_industry, experiences_job_type, experiences_years}) => {
    return (
        <div className='w-full md:w-1/2 rounded-lg text-black p-5 md:p-10' key={id}>
            ...
            <div className='p-1 pl-5 pr-3 rounded-lg flex justify-evenly items-center text-sm mt-2 mb-3 rounded-e-full rounded-s-full' style={{ boxShadow: "rgba(0, 0, 0, 0.16) 0px 1px 4px" }}>
                ...
                <div className='mt-2 mb-3 w-60'>
                    <p className='font-semibold text-lg mb-2'>{certifications_course_name}</p>
                    <p className='font-semibold text-sm'>{certifications_institute}</p>
                </div>
            </div>
            ...
            <div className='mt-8 p-5 rounded-lg' style={{ boxShadow: "rgba(0, 0, 0, 0.16) 0px 1px 4px" }}>
                <div className='flex justify-between items-center text-sm mt-2 mb-3'>
                    <p className='font-semibold text-sm'>{experiences_years} ({experiences_duration_start} - {experiences_duration_end})</p>
                    <p className='font-semibold text-sm'>{experiences_job_type}</p>
                </div>
                <div className='flex justify-between items-center text-sm mt-2 mb-3'>
                    <p className='text-sm'>{experiences_industry}</p>
                    <p className='text-sm'>-- {experiences_designation}</p>
                </div>
            </div>
            ...
            <div className='mt-8 p-5 rounded-lg' style={{ boxShadow: "rgba(0, 0, 0, 0.16) 0px 1px 4px" }}>
                <p>{education_institute}</p>
                <div className='flex justify-between items-center text-sm mt-2 mb-3'>
                    <p className='font-semibold text-sm'>{education_duration_start}</p>
                    <p className='font-semibold text-sm'>{education_duration_end}</p>
                </div>
