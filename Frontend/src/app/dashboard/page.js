    ...
    <>
      ...
      <div className="min-h-screen">
        <div className="flex">
          ...
          <div className='w-11/12 h-20 border flex justify-end'>
            <div className='w-50 border flex justify-between items-center'>
              ...
              <div className='flex justify-between items-center'>
                <div><img src="https://t3.ftcdn.net/jpg/03/42/99/68/360_F_342996846_tHMepJOsXWwbvMpG7uiYpE68wbfQ9e4s.jpg" className='w-10' alt="" /></div>
                <div>
                  <p>Welcome back</p>
